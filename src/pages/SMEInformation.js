  ...
  const smeData = [
    {
      ...
      specializations: ["AI/ML", "Data Science", "Computer Vision"],
      status: "Active",
      rating: 4.8,
      totalMeetings: 156,
      joinedDate: "2024-03-15",
      avatar: "https://via.placeholder.com/60x60/4285f4/ffffff?text=SC",
      portfolio: {
        projects: [
          { name: "Healthcare AI Platform", status: "Completed", duration: "6 months" },
          { name: "Smart City Analytics", status: "In Progress", duration: "4 months" },
          { name: "Educational ML System", status: "Completed", duration: "3 months" }
        ],
      ...
      scheduledMeets: [
        ...
        { 
          id: 3, 
          with: "John Smith", 
          topic: "Data Pipeline Consultation", 
          date: "2025-08-02", 
          time: "16:00", 
          duration: "90 mins",
          status: "Confirmed"
      ...
      workingHours: {
        today: { hours: 6.5, meetings: 3, consultations: 2 },
        week: { hours: 28, meetings: 12, consultations: 8 },
        month: { hours: 142, meetings: 45, consultations: 32 }
      }
    },
    {
      id: 2,
      ...
      specializations: ["Blockchain", "Fintech", "Cybersecurity"],
      status: "Active",
      rating: 4.9,
      totalMeetings: 203,
      joinedDate: "2024-01-20",
      avatar: "https://via.placeholder.com/60x60/34a853/ffffff?text=MR",
      portfolio: {
        projects: [
          { name: "DeFi Security Audit", status: "Completed", duration: "8 months" },
          { name: "Banking Blockchain Integration", status: "In Progress", duration: "6 months" },
          { name: "Crypto Wallet Security", status: "Completed", duration: "4 months" },
          { name: "Smart Contract Optimization", status: "Planning", duration: "TBD" }
        ],
        skills: ["Blockchain", "Solidity", "Security Auditing", "Smart Contracts", "DeFi"],
        experience: "12 years",
        education: "PhD Cryptography, MIT"
      },
      scheduledMeets: [
        { 
          id: 4, 
      ...
      workingHours: {
        today: { hours: 7.2, meetings: 2, consultations: 3 },
        week: { hours: 32, meetings: 8, consultations: 12 },
        month: { hours: 158, meetings: 35, consultations: 48 }
      }
    },
    {
      id: 3,
      name: "Dr. Emily Johnson",
      email: "emily.j@biotech.com",
      specializations: ["Biotechnology", "Pharmaceutical Research", "Clinical Trials"],
      status: "Busy",
      rating: 4.7,
      totalMeetings: 89,
      joinedDate: "2024-05-10",
      avatar: "https://via.placeholder.com/60x60/ff9800/ffffff?text=EJ",
      portfolio: {
        projects: [
          { name: "Drug Discovery Platform", status: "In Progress", duration: "12 months" },
          { name: "Clinical Trial Management", status: "Completed", duration: "9 months" }
        ],
        skills: ["Biotechnology", "Clinical Research", "Regulatory Affairs", "Drug Development"],
        experience: "15 years",
      ...
      workingHours: {
        today: { hours: 8.0, meetings: 4, consultations: 1 },
        week: { hours: 35, meetings: 15, consultations: 6 },
        month: { hours: 168, meetings: 52, consultations: 28 }
      }
    },
    {
      id: 4,
      name: "James Thompson",
      email: "james.t@greentech.io",
      specializations: ["Renewable Energy", "Sustainability", "Environmental Engineering"],
      status: "Inactive",
      rating: 4.5,
      totalMeetings: 67,
      joinedDate: "2024-07-01",
      avatar: "https://via.placeholder.com/60x60/9c27b0/ffffff?text=JT",
      portfolio: {
        projects: [
          { name: "Solar Panel Optimization", status: "Completed", duration: "5 months" },
          { name: "Wind Energy Analytics", status: "On Hold", duration: "TBD" }
        ],
        skills: ["Renewable Energy", "Environmental Science", "Project Management", "Sustainability"],
        experience: "10 years",
        education: "MS Environmental Engineering, UC Berkeley"
      },
      scheduledMeets: [],
      workingHours: {
        today: { hours: 0, meetings: 0, consultations: 0 },
        week: { hours: 0, meetings: 0, consultations: 0 },
        month: { hours: 45, meetings: 8, consultations: 12 }
      }
    }
  ];
