  ...
  const surveys = [
    {
      ...
      description: "Quarterly customer satisfaction survey to measure service quality and user experience",
      status: "Active",
      sentTo: 45,
      responses: 32,
    ...
    },
    {
      ...
      description: "Internal survey to assess employee satisfaction and workplace culture",
      status: "Active",
      sentTo: 52,
      responses: 28,
    ...
    {
      id: 4,
      title: "Market Research - Mobile App",
      description: "Research survey for mobile app preferences and usage patterns",
      status: "Completed",
      sentTo: 41,
      responses: 39,
